...
Many previous work, such as [He, Yihui, Xiangyu Zhang, and Jian Sun.](#He) explores the methods for structured pruning. The rewinding methods that we will talk about below can be applied to both kinds of pruning.
